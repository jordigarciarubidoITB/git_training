...
public class SwitchBucle{
	public static void main (String[] args){
                Scanner scanner = new Scanner(System.in);
		System.out.println("Introdueix quin color es el teu preferit per veure una petita explicacio sobre ell. Introdueix 'Fi' per sortir:");
                System.out.println("------------------------------------------");
		String color = "";
		while(!(color.equals("Fi"))){
	         	color = scanner.next();
			System.out.println("----------------------------------------------------");
			switch(color){
				case "Verd":
